...
using TwinkleTrayAvalonia.Helpers;

namespace TwinkleTrayAvalonia.Worker
{
    public class Engine
    {
        ...
        private Engine()
        {
            _settingsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "TwinkleTrayAvalonia", "settings.json");
            LoadSettings();
