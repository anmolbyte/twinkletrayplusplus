...
using TwinkleTrayWPF.Models;
using TwinkleTrayWPF.Helpers;

namespace TwinkleTrayWPF.Worker
{
    public class Engine
    {
        ...
        private Engine()
        {
            _settingsPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "TwinkleTrayWPF", "settings.json");
            LoadSettings();
