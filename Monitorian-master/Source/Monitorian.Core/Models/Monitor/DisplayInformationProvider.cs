...
internal static class DisplayInformationProvider
{
	...
	private static extern void RoGetActivationFactory([MarshalAs(UnmanagedType.HString)] string activatableClassId, [In] ref Guid iid, [MarshalAs(UnmanagedType.IInspectable)] out object factory);
	...
	private static Windows.Graphics.Display.DisplayInformation GetForWindow(IntPtr windowHandle)
	{
		...
		var activatableClassId = "Windows.Graphics.Display.DisplayInformation";
		var interopIid = new Guid("7449121C-382B-4705-8DA7-A795BA482013");
		RoGetActivationFactory(activatableClassId, ref interopIid, out object factoryObject);
		var factory = (IDisplayInformationStaticsInterop)factoryObject;
